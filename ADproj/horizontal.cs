...
namespace ADproj
{
    ...
    {
        public void horizontalRemove(int horizontalremove , Bitmap myBitmap , string name)
        {
            ...
            for (int counter = 0; counter < horizontalremove; counter++)
            {
                for (int i = 0; i < width; i++)
                {
                ...
                saveBitmap.RotateFlip(RotateFlipType.Rotate270FlipNone);
                saveBitmap.Save(@"D:\university\AD entezari\ADproj\Create\" + name + @"\horizontalWithRed" + counter + ".jpg");
                saveBitmap.RotateFlip(RotateFlipType.Rotate90FlipNone);
                ...
                if (counter == 0)
                    Console.WriteLine("One horizontalfinal pixel has been removed");
                else
                    Console.WriteLine(counter + 1 + " horizontalfinal pixels has been removed");
            }
            ...
            Console.WriteLine("horizontalfinal Done");
            finalBitmap.RotateFlip(RotateFlipType.Rotate270FlipNone);

            if (System.IO.Directory.Exists(@"D:\university\AD entezari\ADproj\image\" + name + "result"))
                System.IO.Directory.Delete(@"D:\university\AD entezari\ADproj\image\" + name + "result", true);

            System.IO.Directory.CreateDirectory(@"D:\university\AD entezari\ADproj\image\" + name + "result");

            finalBitmap.Save(@"D:\university\AD entezari\ADproj\image\"+name+ @"result\horizontalfinalImage.jpg");
        }
    }
}
